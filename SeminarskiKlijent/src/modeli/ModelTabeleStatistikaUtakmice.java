 ...
 * @author Windows HD
 */
public class ModelTabeleStatistikaUtakmice extends AbstractTableModel {

    ArrayList<Statistika> lista;
    String[] kolone = new String[]{"Ime", "Prezime", "Klub", "Golovi", "Faulovi", "Žuti kartoni", "Pretrčano", "Odbrane","Utakmica"};
    private Class[] klaseKolona = new Class[]{String.class, String.class, String.class, Integer.class, Integer.class, Integer.class, Double.class, Integer.class, Integer.class};

    public ModelTabeleStatistikaUtakmice() {
        lista = new ArrayList<>();
    }
    ...
    public Object getValueAt(int red, int kolona) {
        ...
        switch (kolona) {
            ...
            case 8:
                return stat.getUtakmica().getUtakmicaID();
            default:
                return "n/a";
        }
    }
